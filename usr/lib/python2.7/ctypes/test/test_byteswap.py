...
# Embedded file name: /usr/lib/python2.7/ctypes/test/test_byteswap.py
...
class Test(unittest.TestCase):
    ...
    def test_struct_struct(self):
        for nested, data in (
         (
          BigEndianStructure, '\x00\x00\x00\x01\x00\x00\x00\x02'),
         (
          LittleEndianStructure, '\x01\x00\x00\x00\x02\x00\x00\x00')):
            for parent in (
             BigEndianStructure,
