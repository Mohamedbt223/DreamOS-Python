...
# Embedded file name: /usr/lib/python2.7/ctypes/test/test_cfuncs.py
...
class CFunctions(unittest.TestCase):
    ...
    def test_ulonglong(self):
        ...
        self.assertEqual(self._dll.tf_Q(18446744073709551615L), 6148914691236517205)
    ...
    def test_ulonglong_plus(self):
        ...
        self.assertEqual(self._dll.tf_bQ(0, 18446744073709551615L), 6148914691236517205)
        self.assertEqual(self.U(), 18446744073709551615L)
        return
