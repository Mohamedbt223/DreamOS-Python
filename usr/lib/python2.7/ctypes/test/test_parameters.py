...
# Embedded file name: /usr/lib/python2.7/ctypes/test/test_parameters.py
...
class SimpleTypesTestCase(unittest.TestCase):
    ...
    def test_cstrings(self):
        ...
        self.assertRaises(UnicodeEncodeError, c_char_p.from_param, u'\u30xff')
    ...
    def test_cw_strings(self):
        ...
        self.assertRaises(UnicodeDecodeError, c_wchar_p.from_param, b'123\xff')
