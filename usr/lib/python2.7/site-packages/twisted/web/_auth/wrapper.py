...
# Embedded file name: /usr/lib/python2.7/site-packages/twisted/web/_auth/wrapper.py
# Compiled at: 2012-02-19 17:42:58
"""
...
class UnauthorizedResource(object):
    ...
    def render(self, request):
        ...
        for fact in self._credentialFactories:
            ...
            request.responseHeaders.addRawHeader('www-authenticate', generateWWWAuthenticate(fact.scheme, challenge))
...
class HTTPAuthSessionWrapper(object):
    ...
    def _loginFailed(self, result):
        ...
        if result.check(error.Unauthorized, error.LoginFailed):
            ...
            log.err(result, 'HTTPAuthSessionWrapper.getChildWithDefault encountered unexpected error')
            return ErrorPage(500, None, None)
            return
