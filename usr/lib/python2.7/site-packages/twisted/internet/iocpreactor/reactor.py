...
# Embedded file name: /usr/lib/python2.7/site-packages/twisted/internet/iocpreactor/reactor.py
# Compiled at: 2013-03-06 04:23:18
"""
...
try:
    ...
    _extraInterfaces = ()
    warnings.warn('pyOpenSSL 0.10 or newer is required for SSL support in iocpreactor. It is missing, so the reactor will not support SSL APIs.')
else:
    _extraInterfaces = (
     interfaces.IReactorSSL,)

MAX_TIMEOUT = 2000
EVENTS_PER_LOOP = 1000
...
class IOCPReactor(base._SignalReactorMixin, base.ReactorBase, _ThreadedWin32EventsMixin):
    implements(interfaces.IReactorTCP, interfaces.IReactorUDP, interfaces.IReactorMulticast, interfaces.IReactorProcess, *_extraInterfaces)
    port = None
    ...
    def doIteration(self, timeout):
        ...
        while 1:
            ...
            if key != KEY_WAKEUP:
                ...
                log.callWithLogger(evt.owner, self._callEventCallback, rc, bytes, evt)
                processed_events += 1
