...
# Embedded file name: /usr/lib/python2.7/site-packages/twisted/internet/iocpreactor/udp.py
# Compiled at: 2014-02-02 13:07:17
"""
...
class Port(abstract.FileHandle):
    ...
    """
    implements(IReadWriteHandle, interfaces.IListeningPort, interfaces.IUDPTransport, interfaces.ISystemHandle)
    ...
    def __init__(self, port, proto, interface='', maxPacketSize=8192, reactor=None):
        ...
        self.addressLengthBuffer = _iocp.AllocateReadBuffer(struct.calcsize('i'))
        return
    ...
    def doRead(self):
        ...
        rc, bytes = _iocp.recvfrom(self.getFileHandle(), buff, addr_buff, addr_len_buff, evt)
    ...
    def write(self, datagram, addr=None):
        ...
        if self._connectedAddr:
            ...
            assert addr != None
            if not isIPAddress(addr[0]) and not isIPv6Address(addr[0]) and addr[0] != '<broadcast>':
