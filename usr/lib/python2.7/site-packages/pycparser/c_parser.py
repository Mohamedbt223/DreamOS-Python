...
# Embedded file name: /usr/lib/python2.7/site-packages/pycparser/c_parser.py
# Compiled at: 2015-06-10 03:56:52
import re
...
class CParser(PLYParser):
    ...
    def p_direct_declarator_4(self, p):
        ...
        """
        listed_quals = [item if isinstance(item, list) else [item] for item in [
         p[3], p[4]]]
    ...
    def p_expression(self, p):
        ...
        if len(p) == 2:
            p[0] = p[1]
        elif not isinstance(p[1], c_ast.ExprList):
