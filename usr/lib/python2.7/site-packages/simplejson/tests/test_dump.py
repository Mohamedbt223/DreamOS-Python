...
# Embedded file name: /usr/lib/python2.7/site-packages/simplejson/tests/test_dump.py
# Compiled at: 2014-09-29 22:18:10
...
class TestDump(TestCase):
    ...
    def test_stringify_key(self):
        ...
        for v in [{}, {'other': 1}, {(b('derp')): 1, 'herp': 2}]:
            for sort_keys in [False, True]:
                ...
                self.assertEqual(json.loads(json.dumps({'': v0}, skipkeys=True, sort_keys=sort_keys)), {'': v1})
                self.assertEqual(json.loads(json.dumps([v0], skipkeys=True, sort_keys=sort_keys)), [
                 v1])
    ...
    def test_encode_truefalse(self):
        ...
        self.assertEqual(json.dumps({2: 3.0, 4.0: (long_type(5)), 
           False: 1, 
           (long_type(6)): True, 
           '7': 0}, sort_keys=True), '{"2": 3.0, "4.0": 5, "6": true, "7": 0, "false": 1}')
        return
