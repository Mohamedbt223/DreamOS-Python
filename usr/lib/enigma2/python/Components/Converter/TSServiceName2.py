...
# Embedded file name: /usr/lib/enigma2/python/Components/Converter/TSServiceName2.py
# Compiled at: 2016-06-04 10:52:24
from Components.Converter.Converter import Converter
from enigma import iServiceInformation, iPlayableService, iPlayableServicePtr, eServiceReference, eServiceCenter, eTimer, iDVBFrontend
from Components.Element import cached
from Components.config import config

class TSServiceName2(Converter, object):
    NAME = 0
    NUMBER = 1
    BOUQUET = 2
    PROVIDER = 3
    ...
    def __init__(self, type):
        ...
        self.__timer = eTimer()
        self.__timer_conn = self.__timer.timeout.connect(self.neededChange)
        return
        ...
        while True:
            ...
            if f == 't':
                ...
                if type == iDVBFrontend.feCable or type == iDVBFrontend.feSatellite:
                    ...
                    result += x in range(10) + [15] and {0: 'Auto', 1: '1/2', 
                       2: '2/3', 
                       3: '3/4', 
                       4: '5/6', 
                       5: '7/8', 
                    ...
                    result += x in range(6) and {0: '1/2', 1: '2/3', 
                       2: '3/4', 
                       3: '5/6', 
                       4: '7/8', 
                       5: 'Auto'}[x] or ''
                ...
                result += x in range(3) and {0: 'On', 1: 'Off', 
                   2: 'Auto'}[x] or ''
            elif f == 'O':
                if type == iDVBFrontend.feSatellite:
                ...
                if type == iDVBFrontend.feSatellite:
                    result += x in range(4) and {0: 'Auto', 1: 'QPSK', 
                       2: '8PSK', 
                       3: 'QAM16'}[x] or ''
                elif type == iDVBFrontend.feCable:
                    result += x in range(6) and {0: 'Auto', 1: 'QAM16', 
                       2: 'QAM32', 
                       3: 'QAM64', 
                       4: 'QAM128', 
                       5: 'QAM256'}[x] or ''
                ...
                if type == iDVBFrontend.feSatellite:
                    ...
                    result += x in range(4) and {0: 'H', 1: 'V', 
                       2: 'L', 
                       3: 'R'}[x] or '?'
            elif f == 'Y':
                if type == iDVBFrontend.feCable or type == iDVBFrontend.feSatellite:
                ...
                if x is not None:
                    result += x in range(3) and {0: '0.35', 1: '0.25', 
                       2: '0.20'}[x] or ''
            elif f == 'o':
                x = self.tpdata.get('pilot')
                if x is not None:
                    result += x in range(3) and {0: 'Off', 1: 'On', 
                       2: 'Auto'}[x] or ''
            elif f == 'c':
                if type == iDVBFrontend.feTerrestrial:
                    x = self.tpdata.get('constellation', 3)
                    result += x in range(4) and {0: 'QPSK', 1: 'QAM16', 
                       2: 'QAM64', 
                       3: 'Auto'}[x] or ''
            elif f == 'l':
                if type == iDVBFrontend.feTerrestrial:
                ...
                if type == iDVBFrontend.feTerrestrial:
                    ...
                    result += x in range(3) and {0: '2k', 1: '8k', 
                       2: 'Auto'}[x] or ''
            elif f == 'g':
                if type == iDVBFrontend.feTerrestrial:
                    x = self.tpdata.get('guard_interval', 4)
                    result += x in range(5) and {0: '1/32', 1: '1/16', 
                       2: '1/8', 
                       3: '1/4', 
                       4: 'Auto'}[x] or ''
            elif f == 'b':
                if type == iDVBFrontend.feTerrestrial:
                    ...
                    result += x in range(4) and {0: '8 MHz', 1: '7 MHz', 
                       2: '6 MHz', 
                       3: 'Auto'}[x] or ''
            elif f == 'e':
                if type == iDVBFrontend.feTerrestrial:
                    x = self.tpdata.get('hierarchy_information', 4)
                    result += x in range(5) and {0: 'None', 1: '1', 
                       2: '2', 
                       3: '4', 
                       4: 'Auto'}[x] or ''
            else:
