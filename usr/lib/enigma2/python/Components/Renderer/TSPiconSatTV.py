...
# Embedded file name: /usr/lib/enigma2/python/Components/Renderer/TSPiconSatTV.py
# Compiled at: 2015-04-12 02:27:35
from Renderer import Renderer
from enigma import ePixmap
from Tools.Directories import fileExists, SCOPE_SKIN_IMAGE, SCOPE_CURRENT_SKIN, resolveFilename
DVB_S = 0

class TSPiconSatTV(Renderer):
    __module__ = __name__
