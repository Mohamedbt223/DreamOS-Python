...
# Embedded file name: /usr/lib/enigma2/python/Plugins/TSimage/TSimagePanel/Stools/TSsatEditor/ServiceEditor/Transponder.py
# Compiled at: 2014-03-02 12:38:30
...
class Transponder:
    ...
    niceToHave = ['system',
     ...
     'tsid',
     'onid']
    transSystem = {'0': 'DVB-S', '1': 'DVB-S2', 
       'dvb-s': 'DVB-S', 
       'dvb-s2': 'DVB-S2'}
    reTransSystem = {'DVB-S': '0', 'DVB-S2': '1'}
    transPolarisation = {'0': 'H', 'h': 'H', 
       '1': 'V', 
       'v': 'V', 
       '2': 'L', 
       'cl': 'L', 
       ...
       'r': 'R', 
       'i': 'i'}
    reTransPolarisation = {'H': '0', 'V': '1', 
       'L': '2', 
       'R': '3'}
    transModulation = {'0': 'AUTO', '1': 'QPSK', 
       '2': '8PSK', 
       '3': 'QAM16'}
    reTransModulation = {'AUTO': '0', 'QPSK': '1', 
       '8PSK': '2', 
       'QAM16': '3'}
    transRolloff = {'0': '0_35', '1': '0_25', 
       '2': '0_20'}
    reTransRolloff = {'0_35': '0', '0_25': '1', 
       '0_20': '2'}
    transOnOff = {'0': 'OFF', '1': 'ON', 
       '2': 'AUTO'}
    reTransOnOff = {'OFF': '0', 'ON': '1', 
       'AUTO': '2'}
    transFec = {'0': 'FEC_AUTO', '1': 'FEC_1_2', 
       '2': 'FEC_2_3', 
       '3': 'FEC_3_4', 
       '4': 'FEC_5_6', 
       '5': 'FEC_7_8', 
       ...
       '9/10': 'FEC_9_10', 
       'none': 'FEC_NONE'}
    reTransFec = {'FEC_AUTO': '0', 'FEC_1_2': '1', 
       'FEC_2_3': '2', 
       'FEC_3_4': '3', 
       'FEC_5_6': '4', 
       'FEC_7_8': '5', 
