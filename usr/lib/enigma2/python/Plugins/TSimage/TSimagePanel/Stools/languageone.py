...
# Embedded file name: /usr/lib/enigma2/python/Plugins/TSimage/TSimagePanel/Stools/languageone.py
# Compiled at: 2015-12-25 18:03:20
...
class TSilangScreen(Screen):
    ...
    def __init__(self, session):
        ...
        self.removeIcon = LoadPixmap(cached=True, path=resolveFilename(SCOPE_CURRENT_SKIN, '/usr/lib/enigma2/python/Plugins/TSimage/TSimagePanel/buttons/remove.png'))
        self['actions'] = ActionMap(['SetupActions', 'ColorActions'], {'blue': (self.removeLang), 'yellow': (self.selectDeselectAll), 
