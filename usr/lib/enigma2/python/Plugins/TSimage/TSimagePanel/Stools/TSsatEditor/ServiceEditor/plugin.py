...
# Embedded file name: /usr/lib/enigma2/python/Plugins/TSimage/TSimagePanel/Stools/TSsatEditor/ServiceEditor/plugin.py
# Compiled at: 2016-06-30 08:44:25
...
class ServiceList(MenuList):
    ...
    def buildEntry(self, service):
        ...
        serviceEntry.append(MultiContentEntryPixmapAlphaTest(pos=(0, 0), size=(24,
                                                                               24), png=service_png))
        if int(service.get('flags', 0)) & dxDontshow:
            ...
            backcolor = None
            backcolor_sel = None
        serviceEntry.append(MultiContentEntryText(pos=(calc_xpos(serviceEntry), 0), size=(276,
                                                                                          24), font=0, flags=RT_HALIGN_CENTER | RT_VALIGN_TOP, text=service['name'], backcolor=backcolor, backcolor_sel=backcolor_sel, border_width=1, border_color=806544))
        serviceEntry.append(MultiContentEntryText(pos=(calc_xpos(serviceEntry), 0), size=(155,
                                                                                          24), font=0, flags=RT_HALIGN_CENTER | RT_VALIGN_TOP, text=service['provider'], border_width=1, border_color=806544))
...
class TSiServiceEditor(Screen, ConfigListScreen):
    ...
    def __init__(self, session, service=None):
        ...
        self.createConfig()
        self['actions'] = ActionMap(['OkCancelActions', 'ColorActions'], {'cancel': (self.cancel), 'ok': (self.okExit), 
           'red': (self.cancel), 
           'green': (self.okExit)}, -1)
    ...
    def createConfig(self):
        ...
        self.configServiceAChannel = ConfigInteger(default=int(self.serviceAChannel, 16), limits=(0,
                                                                                                  2))
        self.configServiceAC3Delay = ConfigInteger(default=int(self.serviceAC3Delay, 16), limits=(0,
                                                                                                  65535))
        self.configServicePCMDelay = ConfigInteger(default=int(self.servicePCMDelay, 16), limits=(0,
                                                                                                  65535))
...
class Laufschrift(HTMLComponent, GUIComponent):
    ...
    def __init__(self):
        ...
        self.myTimer = eTimer()
        self.myTimer_conn = self.myTimer.timeout.connect(self.laufschrift)
...
class ServiceHideMenuSelection(Screen):
    ...
    def __init__(self, session, service=None):
        ...
        self['actions'] = ActionMap(['OkCancelActions'], {'ok': (self.okbuttonClick), 'cancel': (self.cancel)}, -1)
        self.onLayoutFinish.append(self.layoutFinished)
        return
...
class TSiServicesEditor(Screen):
    skin = '\n                <screen name="TSiServicesEditor" position="center,77" size="920,600" title=""  >\n                <eLabel position="20,525" size="880,2" text="" font="Regular;24" zPosition="-1" backgroundColor="#ffffff"  />\n\t        <ePixmap name="red"    position="70,545"   zPosition="1" size="140,40" pixmap="/usr/lib/enigma2/python/Plugins/TSimage/TSimagePanel/buttons/key_red.png" transparent="1" alphatest="blend" />\n\t        <ePixmap name="green"  position="280,545" zPosition="1" size="140,40" pixmap="/usr/lib/enigma2/python/Plugins/TSimage/TSimagePanel/buttons/key_green.png" transparent="1" alphatest="blend" />\n\t        <ePixmap name="yellow" position="490,545" zPosition="1" size="140,40" pixmap="/usr/lib/enigma2/python/Plugins/TSimage/TSimagePanel/buttons/key_yellow.png" transparent="1" alphatest="blend" /> \n        \t<ePixmap name="blue"   position="700,545" zPosition="1" size="140,40" pixmap="/usr/lib/enigma2/python/Plugins/TSimage/TSimagePanel/buttons/key_blue.png" transparent="1" alphatest="blend" /> \n        \t<widget name="key_red" position="70,550" size="140,40" valign="center" halign="center" zPosition="2"  font="Regular;21" transparent="1" /> \n        \t<widget name="key_green" position="280,550" size="140,40" valign="center" halign="center" zPosition="2" font="Regular;21" transparent="1" /> \n                <widget name="key_yellow" position="490,555" size="140,40" valign="center" halign="center" zPosition="2" font="Regular;20" transparent="1" />\n        \t<widget name="key_blue" position="700,550" size="140,40" valign="center" halign="center" zPosition="2" font="Regular;21" transparent="1" />\t\n\t\t<widget name="info" position="20,100" zPosition="4" size="880,300" font="Regular;22" transparent="1" halign="center" valign="center" /> \t\t\n\t\t<widget name="laufschrift" position="0,25" size="54,24" scrollbarMode="showNever" transparent="1" zPosition="2" />\n\t\t<widget name="head" position="169,25" size="575,24" scrollbarMode="showNever" transparent="1" zPosition="2" />\n\t\t<widget name="list" position="155,49" size="580,290" scrollbarMode="showOnDemand" transparent="1" zPosition="2" />\n\t\t<widget name="infolist" position="155,369" size="710,96" transparent="1" zPosition="2" />\n\t\t</screen>'

    def __init__(self, session):
        self.skin = TSiServicesEditor.skin
        Screen.__init__(self, session)
        self.usk = None
        self.cur_service = None
        self.mainTitle = 'Edit services'
        self['actions'] = ActionMap(['ServicesEditorActions'], {'nextPage': (self.nextPage), 'nextPageUp': (self.selectionKeyUp), 
    ...
    def setWindowTitle(self):
        self.setTitle('Edit services')
        return

    def layoutFinished(self):
        self.myTimer_conn = self.myTimer.timeout.connect(self.initDatabase)
    ...
    def initDatabase(self):
        ...
        if self.lamedb.databaseState < 3:
            ...
            if self.lamedb.databaseState == 3:
                ...
                return
            if self.lamedb.databaseState == 4:
    ...
    def getInfo(self):
        ...
        transFec = {'0': 'auto', '1': '1/2', 
           ...
           '8': '4/5', 
           '9': '9/10'}
        transFecTerr = {'0': '1/2', '1': '2/3', 
           '2': '3/4', 
           '3': '5/6', 
           '4': '7/8', 
           '5': 'auto'}
        transModulation = {'1': 'QPSK', '2': '8PSK', 
           '3': 'QAM16'}
        transModulationCable = {'0': 'auto', '1': 'QAM16', 
           '2': 'QAM32', 
           '3': 'QAM64', 
           '4': 'QAM128', 
           '5': 'QAM256'}
        transModulationTerr = {'0': 'QPSK', '1': 'QAM16', 
           '2': 'QAM64', 
           '3': 'auto'}
        transBandwidth = {'0': '8MHz', '1': '7MHz', 
           '2': '6MHz', 
           '3': 'auto'}
        print 'getInfo'
        self['infolist'].l.setFont(0, gFont('Regular', 20))
    ...
    def editService(self):
        ...
        if self.cur_service is None:
            ...
            self.session.openWithCallback(self.finishedServiceEdit, TSiServiceEditor, self.cur_service)
            return
