...
# Embedded file name: /usr/lib/enigma2/python/Plugins/Extensions/WebInterface/WebComponents/Sources/MP.py
...
class MP(Source):
    ...
    def getFileList(self, param):
        ...
        try:
            ...
            matchingPattern = '(?i)^.*\\.(mp2|mp3|ogg|ts|wav|wave|m3u|pls|e2pls|mpg|vob|avi|divx|m4v|mkv|mp4|m4a|dat|flac|mov|m2ts)'
        ...
        if mp is None:
            ...
            for mpref in serviceRefList:
                if mpref == ref:
                    ...
                    mp.playlist.updateList()
                    return (
                     True, _("'%s' removed from playlist") % file)
                i += 1
    ...
    def command(self, param):
        ...
        if mp is None:
            ...
            if param == 'previous':
                ...
                return (
                 False, _('Unknown parameter %s') % param)
            return (
             True, _("Command '%s' executed") % param)
