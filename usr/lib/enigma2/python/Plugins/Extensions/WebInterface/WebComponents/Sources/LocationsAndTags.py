...
# Embedded file name: /usr/lib/enigma2/python/Plugins/Extensions/WebInterface/WebComponents/Sources/LocationsAndTags.py
                ...
                if param['createFolder'] is not None:
                    if param['createFolder'] == '1':
                        try:
                            ...
                            return (
                             False, _('Path %s can not be created') % dirname)
    ...
    def removeLocation(self, param):
        ...
        if len(param) == 0:
            ...
            if dirname in bookmarks:
                ...
                config.movielist.videodirs.save()
                return (
                 True, _("Location '%s' removed successfully") % dirname)
