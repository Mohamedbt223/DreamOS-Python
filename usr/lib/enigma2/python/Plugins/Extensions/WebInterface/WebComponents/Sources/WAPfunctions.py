...
# Embedded file name: /usr/lib/enigma2/python/Plugins/Extensions/WebInterface/WebComponents/Sources/WAPfunctions.py
...
class WAPfunctions(Source):
    ...
    def handleCommand(self, cmd):
        ...
        if self.func is self.LISTTIME:
            ...
            self.result = (
             'unknown command cmd(%s) self.func(%s)' % (cmd, self.func),)
        return
