...
from Tools.DreamboxHardware import getFPVersion, getCPUTemp
...
class About(Screen):
	def __init__(self, session):
		...
		self["ImageVersion"] = StaticText("TSimage: " + about.getImageVersionString())
		...
		self["CPUHeader"] = StaticText(_("CPU Temperature:"))
		if cpu_temp is not None:
			self["CPUTemp"] = StaticText("%.1f °C" % (cpu_temp,))
		else:
			self["CPUTemp"] = StaticText(_("n/a"))
